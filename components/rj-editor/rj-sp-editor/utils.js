...
export const linkFlag =
  "RJ.DJ.rj.dj#r-r*r=r*r-r*r=r*r-r*r=r*@-link-flag-link-@#r-r*r=r*r-r*r=r*r-r*r=r*RJ.DJ.rj.dj";
  ...
  editorCtx.getContents({
    success(res) {
      ...
      const findex = options.findIndex((item) => {
        return (
          item.insert && typeof item.insert !== "object" && item.insert?.indexOf(linkFlag) !== -1
        );
      });
      // 根据标识查找到插入的位置
      if (findex > -1) {
